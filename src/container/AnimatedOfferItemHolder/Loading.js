...
const Loading = () => {
  return (
    <div className="flex flex-col overflow-hidden animate-pulse group3_premium  bg-anova2 my-5 border-2 border-anova3 rounded-lg p-4 gap-2">
      ...
      <div className="flex justify-between gap-5 z-40 w-full">
